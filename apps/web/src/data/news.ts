...
let newsArticles: NewsArticle[] = globalThis.__newsArticles || [
  {
    ...
    sourceName: '新华网财经',
    sourceType: 'rss',
    featuredImage: '/api/placeholder/600/400?bg=3b82f6&color=ffffff&text=服装行业',
    aiProcessed: false,
  ...
  },
  {
    ...
    sourceName: '中国纺织网',
    sourceType: 'rss',
    featuredImage: '/api/placeholder/600/400?bg=10b981&color=ffffff&text=市场调研',
    aiProcessed: false,
    aiProcessStatus: 'pending',
    viewCount: 89,
    likeCount: 5,
  ...
  },
  {
    ...
    sourceName: '商务部网站',
    sourceType: 'rss',
    featuredImage: '/api/placeholder/600/400?bg=f59e0b&color=ffffff&text=商务资讯',
    aiProcessed: false,
    aiProcessStatus: 'pending',
    viewCount: 0,
    likeCount: 0,
...
function convertToPublicFormat(article: NewsArticle) {
  return {
    ...
    image: article.featuredImage || '/api/placeholder/600/400?bg=6366f1&color=ffffff&text=新闻图片',
